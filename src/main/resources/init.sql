...
INSERT INTO coupons (name, user_id, percentage)
VALUES ('Sausage discount', 1,10),         -- 1
       ('Bread super-sale', 1, 50),         -- 2
       ('Bread super-sale', 1, 40),         -- 3
       ('20% off from EVERYTHING!', 2, 20), -- 4
       ('1 product for FREE!', 3, 100); -- 5

INSERT INTO coupons_shops (coupon_id, shop_id)
VALUES (1, 1), -- 1
       (1, 2),
       (1, 3),
       (2, 1), -- 2
